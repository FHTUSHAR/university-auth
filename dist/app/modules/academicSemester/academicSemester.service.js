...
const getAllSemester = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemester_model_1.AcademicSemester.find(filter)
        .sort(sortCondition)
        .skip(skip)
        .limit(limit);
...
const updateSemester = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (payload.title && payload.code && academicSemester_constant_1.academicSemesterTitleCodeMapper[payload.title] !== payload.code) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid Semester Code!");
    }
    const filter = { _id: id };
    const options = { new: true };
    const result = yield academicSemester_model_1.AcademicSemester.findOneAndUpdate(filter, payload, options);
    return result;
});
