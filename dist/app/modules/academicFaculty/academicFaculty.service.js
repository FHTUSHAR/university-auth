...
const updateFaculty = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicFaculty_model_1.AcademicFaculty.findByIdAndUpdate(filters, payload, options);
    return result;
});
const getAllFaculty = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicFaculty_model_1.AcademicFaculty.find(filter)
        .sort(sortCondition)
        .skip(skip)
        .limit(limit);
