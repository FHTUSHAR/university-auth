...
const updateDepartment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicDepartment_model_1.AcademicDepartment.findByIdAndUpdate(filters, payload, options).populate('academicFaculty');
    return result;
});
const getAllDepartment = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicDepartment_model_1.AcademicDepartment.find(filter)
