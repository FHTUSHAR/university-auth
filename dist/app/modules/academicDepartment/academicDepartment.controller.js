...
const updateDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicDepartment_service_1.AcademicDepartmentService.updateDepartment(id, payload);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const getAllDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, academicDepartment_constant_1.filterableFields);
